...
<!-- Just returing the value after function operates -->
<?php
  function doubleme($x){
    return $x *2;
  }
...
<!-- Return benefits in functions -->
<?php 

function doubleme3($x){
  return $x *2;
}
...
// 1-> We can one return value in another functions

echo tripleMe(doubleMe(5));

?>

<!-- Differece between the_ and get_ -->
<?php 
...
// 1- get will return the values of function, it's upto us where we can put and use it
// 2- the_ will do echo part too   
